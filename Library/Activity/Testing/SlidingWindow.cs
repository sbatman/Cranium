		...
		public override TestResults TestNetwork()
		{
			...
			for (Int32 s = 0; s < _SequenceCount; s++)
			{
				...
				for (Int32 i = 0; i < _WindowWidth; i++)
				{
					...
					if (_UpdatingLayers != null)
						foreach (RecurrentContext layer in _UpdatingLayers.Cast<RecurrentContext>())
							layer.UpdateExtra();
				}
