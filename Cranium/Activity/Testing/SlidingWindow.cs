...
namespace Cranium.Lib.Activity.Testing
{
    ...
    public class SlidingWindow : Base
    {
        ...
        /// <summary> Sets teh width of the sliding window used for testing </summary>
        ...
        /// <summary> Sets the distance to prediction from the end of the presented window </summary>
        ...
        /// <summary> sets the current dataset used for this test </summary>
        ...
        /// <summary> Perpares any data that is required for testing </summary>
        public override void PrepareData()
        {
            ...
            for (Int32 i = 0; i < _SequenceCount; i++)
            {
                for (Int32 j = 0; j < _WindowWidth; j++)
                {
                    ...
                    if (i + _DistanceToForcastHorrison < _SequenceCount) for (Int32 l = 0; l < outputCount; l++) _ExpectedOutputs[i][l] = _WorkingDataset[l][i + j + _DistanceToForcastHorrison];
                }
            }
        }

        /// <summary> Tests the provided network </summary>
        /// <returns>
        /// Returns acopy of the test results class (or derived class depending on class functionality)
        /// </returns>
        ...
        /// <summary> Returned results class for the SlidingWindow testing activity </summary>
        public class SlidingWindowTestResults : TestResults
        {
            ...
            /// <see cref="Activity.Testing.SlidingWindow.SlidingWindowTestResults" /> class.
            /// </summary>
            ...
            /// <summary>
            /// Initializes a new instance of the
            /// <see cref="Activity.Testing.SlidingWindow.SlidingWindowTestResults" /> class, used
            /// by the serializer.
            /// </summary>
