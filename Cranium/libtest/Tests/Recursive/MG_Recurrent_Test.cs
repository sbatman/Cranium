...
// 
// This work is covered under the Creative Commons Attribution-ShareAlike 3.0 Unported (CC BY-SA
// 3. 0) licence. More information can be found about the liecence here
// http: //creativecommons.org/licenses/by-sa/3.0/ If you wish to discuss the licencing terms please
// contact Steven Batchelor-Manning
// 
// //////////////////////
...
{
    /// <summary>
    /// This is a test of a neural network that can show successful learning of the Mackey-Glass
    /// time series dataset using a standard recursive context node bank for memory.
    /// </summary>
    public static class MgRecurrentTest
    {
        /// <summary> The Neural Network structure that is being tested </summary>
        ...
        /// <summary> The input layer of the nerual network </summary>
        private static Base _InputLayer;

        /// <summary> The hidden layer of the nerual network. </summary>
        private static Base _HiddenLayer;

        /// <summary> The recurvie context layer of the nerual network </summary>
        private static RecurrentContext _ContextLayer;

        /// <summary> The output layer of the neural network </summary>
        private static Base _OutputLayer;

        /// <summary> A list of the input nodes present in this neural network structure </summary>
        private static List<Lib.Structure.Node.Base> _InputLayerNodes;

        /// <summary> A list of the output nodes present in the neural network structure </summary>
        ...
        public static void Run()
        {
            ...
            //PrepData
            DataPreprocessedStandardDeviationVariance dataSetProfile = StandardDeviationVariance.ProduceDataset("TestData/Mackey-Glass-Pure.csv");
            Double[][] dataSet = dataSetProfile.DataSet;
            ...
            // The ammount of the previous weight change applied to current weight change - google
            // if u need to know more
            _SlidingWindowTraining.SetLearningRate(0.004f);
            // The rate at which the neural entwork learns (the more agressive this is the harded
            // itll be for the network)
            ...
            _SlidingWindowTraining.SetMaximumEpochs(25); // The maximum number of epochs the network can train for
            ...
            Functions.PrintArrayToFile(dataSetProfile.DenormalizeDataSet(result.ActualOutputs), "ActualOutputs.csv");
            Functions.PrintArrayToFile(dataSetProfile.DenormalizeDataSet(result.ExpectedOutputs), "ExpectedOutputs.csv");
        ...
        /// <summary> Builds the structure of the neural network to undergo training and testing. </summary>
        public static void BuildStructure()
        {
            ...
            // Add the nodes of the output and hidden layers to the context layer (so it generates
            // context codes)
