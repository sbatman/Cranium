...
namespace Cranium.libtest
{
	class MainClass
	{
		...
		public static void BuildStructure()
		{
			...
			for(int i=0; i<2; i++)InputLayerNodes.Add(new Cranium.Structure.Node.Base(InputLayer,new Cranium.Structure.ActivationFunction.Linear()));
			...
			for(int i=0; i<10; i++)HiddenLayerNodes.Add(new Cranium.Structure.Node.Base(HiddenLayer,new Cranium.Structure.ActivationFunction.BinarySigmoid()));
			...
			for(int i=0; i<1; i++)OuputLayerNodes.Add(new Cranium.Structure.Node.Base(OutputLayer,new Cranium.Structure.ActivationFunction.Linear()));
