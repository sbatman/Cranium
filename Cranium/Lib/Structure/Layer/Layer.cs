...
namespace Cranium.Lib.Structure.Layer
{
	...
	///    The layer class also provides some of the basic functionality for back and forward prorogation. This class can be
	...
	public class Layer : IDisposable, ISerializable
	{
		...
		///    Layer.
		/// </param>
		public virtual void ConnectForwardLayer(Layer layer)
		{
